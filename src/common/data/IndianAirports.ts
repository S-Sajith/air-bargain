...
const IndianAirports: AirportDataFormat[] = [
    /* -------------------------------------------------------------------------- */
    ...
    {
        location: "Chandigarh Capital Region",
        IATA: "IXC",
    ...
    },
    {
        location: "Kolhapur",
        IATA: "KLH",
        airport: "Chhatrapati Rajaram Maharaj Airport",
        state: "Maharashtra"
    },
    {
        location: "Mumbai",
