...
function MobileTicket(props: any) {
        ...
        >
          <Grid item xs={7}>
            ...
            <div style={{ paddingLeft: "3%" }}>
              <Typography
                sx={{
                  borderLeft: "1.5px dashed #cdd5d9",
                  pl: 1,
                  pt: 1,
                  fontSize: "0.8rem",
                  color: "gray",
          ...
          <Grid
            item
            xs={5}
            sx={{ textAlign: "center", borderLeft: "1.2px solid var(--muted)" }}
          >
            <Typography
              variant="h5"
              sx={{ fontWeight: "700", color: "var(--green)" }}
            >
          ...
          <Grid
            container
            sx={{ borderTop: "1.2px dashed var(--muted)", pt: 1, mt: 1 }}
          >
            <Grid item xs={8}>
              {recommended ? (
                <Chip
                ...
                <Chip
                  label="Economy"
                  size="small"
                  className="economy-labelMobile"
                />
              )}{" "}
              &nbsp;
              {qualityLabel ? (
                <Chip label="Premium" className="quality-label" size="small" />
              ) : (
                <></>
              )}
            </Grid>
